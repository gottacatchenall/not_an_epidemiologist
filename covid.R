...
county_levela_covid_data$date = as.Date(county_level_covid_data$date)
...
plt = colorado_full %>% 
    ...
    labs(x='', y='New Cases per capita', title='New Cases per capita, 5-day moving avg, 6/20/20') + scale_x_date() + thm
